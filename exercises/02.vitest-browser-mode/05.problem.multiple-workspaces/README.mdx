...
🐨 First, update <InlineFile file="vite.config.ts">`vite.config.ts`</InlineFile> to list multiple [projects](https://vitest.dev/guide/projects). Define one for unit tests and another for component tests.
