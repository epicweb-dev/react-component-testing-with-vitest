...
The last thing that remains is to make sure TypeScript sees the Vitest globals and browser context types. The matcher types are referenced from `vite-env.d.ts`.
